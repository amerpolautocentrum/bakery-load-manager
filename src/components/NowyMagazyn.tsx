...
interface NowyMagazynProps {
  kierowcaId: string
}

export default function NowyMagazyn({ kierowcaId }: NowyMagazynProps) {
  ...
  const handleDodajCiasto = () => {
    if (!wybraneCiasto || parseFloat(waga) <= 0) {
  ...
  return (
    <div className="p-4 max-w-md mx-auto">
      ...
      <div className="mb-6">
        ...
        <select value={kierowcaId} disabled className="w-full p-2 border rounded">
          {kierowcy.map(k => (
